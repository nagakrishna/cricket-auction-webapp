...
CREATE TABLE "AuctionSettings" (
  ...
  "minBatsmen" INTEGER NOT NULL DEFAULT 2,
  "maxBatsmen" INTEGER NOT NULL DEFAULT 4,
  "minBowlers" INTEGER NOT NULL DEFAULT 3,
  "maxBowlers" INTEGER NOT NULL DEFAULT 6,
  ...
  "maxWicketkeepers" INTEGER NOT NULL DEFAULT 1,
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL
);
